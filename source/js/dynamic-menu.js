...
(function(window, document) {
  window.onload = function() {
    ...
    var MAX_TRANSLATE_Y = fixedMenu.offsetHeight;
    ...
    function render() {
      ...
      fixedMenu.style.transform = 'translateY(' + (translateY - MAX_TRANSLATE_Y) + 'px)';
    }

    if (isMobile) {
      window.onscroll = function() {
        if (
          prevScrollTop > 100 + document.body.scrollTop
          || document.body.scrollTop < (MAX_TRANSLATE_Y / 2)
        ) {
